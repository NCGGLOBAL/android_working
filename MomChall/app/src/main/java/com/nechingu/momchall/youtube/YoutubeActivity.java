...
package com.nechingu.momchall.youtube;
...
import com.nechingu.momchall.youtube.antmedia.liveVideoBroadcaster.LiveVideoBroadcasterActivity;
import com.nechingu.momchall.youtube.util.EventData;
import com.nechingu.momchall.youtube.util.NetworkSingleton;
import com.nechingu.momchall.youtube.util.Utils;
...
public class YoutubeActivity extends Activity implements EventsListFragment.Callbacks {
    ...
    public static final String APP_NAME = "Momchall";
