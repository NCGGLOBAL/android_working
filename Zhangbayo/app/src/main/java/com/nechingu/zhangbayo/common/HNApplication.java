package com.nechingu.zhangbayo.common;
...
public class HNApplication extends Application {
    ...
    public static String URL = "http://zhangbayo.co.kr";
    public static String PUSH_URL = "http://zhangbayo.co.kr/m/app/pushRegister.asp";
