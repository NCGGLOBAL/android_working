package com.mallup.drpay.common;
...
import com.mallup.drpay.MyNotificationManager;
...
public class HNApplication extends Application {
    ...
    public static String URL = "http://drpay.mallup.co.kr";
    public static String PUSH_URL = "http://drpay.mallup.co.kr/m/app/pushRegister.asp";
