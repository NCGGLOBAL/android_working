package com.creator.mallprolive
...
import com.creator.mallprolive.common.BackPressCloseHandler
import com.creator.mallprolive.common.HNApplication
import com.creator.mallprolive.delegator.HNCommTran
import com.creator.mallprolive.delegator.HNCommTranInterface
import com.creator.mallprolive.delegator.HNSharedPreference
import com.creator.mallprolive.helpers.Constants
import com.creator.mallprolive.live.CameraActivity
import com.creator.mallprolive.models.Image
import com.creator.mallprolive.util.*
        ...
        override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
            ...
            if (url.startsWith("ispmobile")) {
                ...
                return if (NicePayUtility.isPackageInstalled(
                    ...
                    val bankPayIntent = Intent(Intent.ACTION_MAIN).apply {
                        component = ComponentName(
                            "com.kftc.bankpay.android",
                            "com.kftc.bankpay.android.activity.MainActivity"
                        )
                        putExtra("requestInfo", reqParam)
                    }
