package com.admin.withel.common;
...
import com.admin.withel.MyNotificationManager;
...
public class HNApplication extends Application {
    ...
    public static String URL = "https://weeket.co.kr";
    public static String PUSH_URL = "https://weeket.co.kr/m/app/pushRegister.asp";
