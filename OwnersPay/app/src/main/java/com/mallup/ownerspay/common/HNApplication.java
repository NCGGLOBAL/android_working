package com.mallup.ownerspay.common;
...
import com.mallup.ownerspay.MyNotificationManager;
...
public class HNApplication extends Application {
    ...
    public static String URL = "http://admin.ownerscaddy.com";
    public static String PUSH_URL = "http://ownerscaddy.com/m/app/pushRegister.asp";
