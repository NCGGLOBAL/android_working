package com.nechingu.wavayopay.common;
...
import com.nechingu.wavayopay.MyNotificationManager;
...
public class HNApplication extends Application {
    ...
    public static String URL = "http://admin.wavayo.shop";
    public static String UPLOAD_URL = "http://admin.wavayopay.com/m/app/";
