package com.mallup.ysfnl.common;
...
import com.mallup.ysfnl.MyNotificationManager;
...
public class HNApplication extends Application {
    ...
    public static String URL = "http://ysfnlmall.co.kr";
    public static String PUSH_URL = "http://ysfnlmall.co.kr/m/app/pushRegister.asp";
