package com.mallup.martnara.common;
...
import com.mallup.martnara.MyNotificationManager;
...
public class HNApplication extends Application {
    ...
    public static String URL = "http://mart119.net";
    public static String PUSH_URL = "http://mart119.net/m/app/pushRegister.asp";
