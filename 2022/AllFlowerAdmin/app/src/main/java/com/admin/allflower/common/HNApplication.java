package com.admin.allflower.common;
...
import com.admin.allflower.MyNotificationManager;
...
public class HNApplication extends Application {
    ...
    public static String URL = "http://modookot.co.kr/addon/m_mallinmall";
    public static String PUSH_URL = "http://modookot.co.kr/m/app/pushRegister.asp";
